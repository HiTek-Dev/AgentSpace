...
must_haves:
  truths:
    ...
    - "All new providers stream correctly through the existing streamText pipeline"
  artifacts:
...
<task type="auto">
  <name>Task 2: Wire Venice tools into tool registry and verify integration</name>
  <files>
    packages/gateway/src/agent/tool-registry.ts
  </files>
  <action>
...
2. Verify hot-swap compatibility:
