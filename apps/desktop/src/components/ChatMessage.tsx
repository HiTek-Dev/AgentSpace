			...
			return (
				<div className="flex justify-end mb-3">
					<div className="max-w-[75%]">
						<div className="bg-blue-600 text-white rounded-2xl rounded-br-md px-4 py-2.5 text-sm leading-relaxed whitespace-pre-wrap">
							{message.content}
						</div>
		...
		if (message.role === "assistant") {
			return (
				<div className="flex justify-start mb-3">
					<div className="max-w-[75%]">
						<div className="bg-gray-800 text-gray-100 rounded-2xl rounded-bl-md px-4 py-2.5 text-sm leading-relaxed whitespace-pre-wrap">
							{message.content}
						</div>
